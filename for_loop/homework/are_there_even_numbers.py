...
def are_there_even_numbers(numbers: list[int]) -> str:
    """
    Defines if at least one number is even.
    ...
    for number in numbers:
        if number % 2 == 0:
            return "There are at least one even number"
...
if __name__ == "__main__":
    ...
    for i in range(n - 1):
        ...
        print(numbers[-1])
    print(are_there_even_numbers(numbers))
